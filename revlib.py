        ...
        try:
            ...
            if (r.status_code == 200):
                ...
                try:
                    ...
                    print("LOG: [AMZN] Error in getting product reviews")
        ...
        try:
            ...
            if (r.status_code == 200):
                ...
                try:
                    ...
                    print("LOG: [FLIP] Error in getting product reviews")
                    review_list = ["Not Available"]
            ...
            if (r.status_code == 200):
                ...
                try:
                    ...
                    for i in range(1, 5):
                        ...
                        if (r.status_code == 200):
                            print(
                                "LOG: [AMZN] Connection Successful to page " + str(i))
                            ...
                            print(
                                "LOG: [AMZN] Connection Failed to page " + str(i))
                ...
                print("LOG: [AMZN] Connection Failed")
                main_reviews = ["Not Available"]
                ...
                try:
                    ...
                    for i in range(2, 5):
                        ...
                        if response.status_code == 200:
                            print(
                                'LOG: [FLIP] Connection Successful to page ' + str(i))
